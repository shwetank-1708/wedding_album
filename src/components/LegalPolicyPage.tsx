...
export default function LegalPolicyPage({
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-24 text-slate-900 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <article className="mt-6 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm md:p-12">
          ...
          <p className="mt-10 rounded-xl bg-slate-50 p-4 text-sm leading-6 text-slate-600">
